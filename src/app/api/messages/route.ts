...
export async function POST(req: Request) {
  try {
    ...
    }) as ChannelWithWorkspace | undefined

    const dmChannel = !regularChannel ? await db.query.directMessageChannels.findFirst({
    ...
    }) as DirectMessageChannelWithMembers | undefined : undefined
